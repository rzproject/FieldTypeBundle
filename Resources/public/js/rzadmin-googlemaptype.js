(function( $ ) {
    ...
    $.fn.rzGoogleMapType = function(settings) {

        settings = $.extend({}, $.fn.rzGoogleMapType.defaultSettings, settings || {});
        ...
        map_el.data('map', new GoogleMapType( settings, map_el ));
        return map_el.data('map').initMap();
    };

    $.fn.rzGoogleMapType.defaultSettings = {
        'search_input_el'    : null,
        'search_action_el'   : null,
        'search_error_el'    : null,
        'current_position_el': null,
